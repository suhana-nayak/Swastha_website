...
const Privacy = () => {
  return (
    <div style={{ margin: "0 auto", maxWidth: "xl" }}>
      ...
      >
        This privacy policy sets out how <b>“Swastha Technovations Private Limited
        (STPL)”</b> uses and protects any information that you give STPL when you
        use this website. <br/>STPL is committed to ensuring that your privacy is
        protected. We will ask you to provide certain information by which you
        can be identified when using this website; then you can be assured that
        it will only be used in accordance with this privacy statement. <br/>STPL may
        ...
        changes. This policy is effective from 30th Jan 2024.<br/> <br/>
        ...
        about your preferences. <br /> We use traffic log cookies to identify
        which pages are being used. This helps us analyse data about web page
        ...
        about you, other than the data you choose to share with us. <br />
        ...
        <li>
          ...
          writing to or emailing us at [email address] 
        </li><br/>
        ...
        or incomplete, please contact us through contact page. We will promptly correct any information found to be
        incorrect.
      </p>
